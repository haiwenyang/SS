  ...
  <div class="container">
	<div class="row clearfix">
		...
		<!-- namespace的标签对div的action不起动作 ，所以action="s2h/addCategory"-->
			<form class="form-horizontal"  action="s2h/addCategory" namespace="" onSubmit="return isValid()">
				<div class="form-group">
					 <label class="col-sm-2 control-label"  >类型名</label>
					<div class="col-sm-10">
						<input class="form-control" style="width: 213px;" name="category1.categoryName" id="category"/>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
					<button class="btn btn-default" type="submit" onclick="return isValid();">提交</button>
					</div>
				</div>
			</form> 
		</div>
