...
<div class="container">
	...
	<div class="col-md-6 column">
			...
			<form class="form-horizontal"  action="s2h/addNews" namespace="" onSubmit="return isValid()">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<s:textarea name="news.content" cols="40" rows="8" id="content"/>
					</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
					<button class="btn btn-default" type="submit" onclick="return isValid();">添加</button>
					</div>
				</div>
			</form> 
