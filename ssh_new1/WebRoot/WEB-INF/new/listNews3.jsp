...
<div class="row clearfix">
	...
	<div class="row clearfix">
		<div class="col-md-5 column">
		   ...
		   <div class="list-group">
				 <a class="list-group-item active" href="listpage.action">新闻查看</a>
		   </div>
	</div>
    ...
    <s:iterator value="newss" var="news">
       <tr>
         ...
         <td><s:date name="#news.issueTime" format="yyyy-MM-dd hh:mm:ss"/></td>
       	...
       	<s:iterator value="pageBean" var="pageList">
        <tr>
         ...
         <!-- currentPage为当前页 -->
         <s:else>
           <a href="listpage.action?page=1">第一页</a>
           <a href="listpage.action?page=<s:property value="%{currentPage-1}"/>">上一页</a>
         </s:else>
    
         <s:if test="%{currentPage != totalPage}">
         <a href="listpage.action?page=<s:property value="%{currentPage+1}"/>">下一页</a>
         <a href="listpage.action?page=<s:property value="totalPage"/>">最后一页</a>
            </s:if>
